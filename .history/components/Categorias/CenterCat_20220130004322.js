...
function CenterCat() {
  ...
  return (
    <Container>
      {cate == "restaurantes" && (
        <Img className="restaurantes">
          <img src="https://images.pexels.com/photos/2983101/pexels-photo-2983101.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260" />
        </Img>
      )}
      {cate == "comercial" && (
        <Img className="comercial">
          <img src="https://images.pexels.com/photos/868110/pexels-photo-868110.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260" />
        </Img>
      )}
