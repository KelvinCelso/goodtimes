...
import { itemState, likedState, uidState } from "../../../atoms/ItemsAtoms";
    ...
    <Container>
      <Content>
        <Wrap>
          ...
          <span onClick={(e) => itemPages(props.id, e)}>{props.name}</span>
          <p onClick={(e) => itemPages(props.id, e)}>{props.address}</p>
          <Checkbox
            checked={checked}
